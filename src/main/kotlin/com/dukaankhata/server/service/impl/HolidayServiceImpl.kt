...
import com.dukaankhata.server.service.converter.HolidayServiceConverter
...
class HolidayServiceImpl : HolidayService() {
    ...
    @Autowired
    private lateinit var holidayServiceConverter: HolidayServiceConverter
    ...
    override fun saveHoliday(saveHolidayRequest: SaveHolidayRequest): SavedHolidayResponse? {
        ...
        val attendance =  holidayUtils.saveOrUpdateHoliday(
            addedBy = addedByUser,
            company = company,
            employee = employee,
        ...
        return holidayServiceConverter.getSavedHolidayResponse(attendance)
    }
