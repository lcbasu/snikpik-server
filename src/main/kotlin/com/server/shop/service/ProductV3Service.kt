...
abstract class ProductV3Service {
    ...
    abstract fun updateBookmarkProductVariant(request: BookmarkProductVariantV3Request): BookmarkedProductVariantsResponse?
    abstract fun getBookmarkedProductVariants(): BookmarkedProductVariantsResponse
