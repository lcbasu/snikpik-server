...
interface UserActivitiesByUserRepository : CassandraRepository<UserActivityByUser?, String?> {
    ...
    fun findAllByByUserIdAndUserAggregateActivityType(byUserId: String, userAggregateActivityType: UserAggregateActivityType, pageable: Pageable): Slice<UserActivityByUser>
}
