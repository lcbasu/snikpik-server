...
@Table("user_chat_last_messages")
class UserChatsLastMessage (

    @PrimaryKeyColumn(name = "chat_id", ordinal = 0, type = PrimaryKeyType.PARTITIONED)
    var chatId: String,

    // Details of Last message
    @Column("created_at")
...
fun UserChatsLastMessage.getCategories(): AllCategoryV2Response {
    this.apply {
        return try {
...
fun UserChatsLastMessage.getMediaDetails(): MediaDetailsV2 {
    this.apply {
