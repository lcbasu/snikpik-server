...
@Table("integration_account_info_by_platform_account_id")
data class IntegrationAccountInfoByPlatformAccountId (
...
data class ShortLivedAccessTokenResponse (
    val model: IntegrationAccountInfoByUserId?,
    val error: Boolean?,
    val errorMessage: String?,
)


fun IntegrationAccountInfoByUserId.toIntegrationAccountInfoByPlatformAccountId(): IntegrationAccountInfoByPlatformAccountId {
    this.apply {
        return IntegrationAccountInfoByPlatformAccountId(
            accountId = accountId,
            platform = platform,
            userId = userId,
            createdAt = createdAt,
